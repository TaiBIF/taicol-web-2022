...
import ClassCountStatisics from 'src/components/frontend/statistics/RankCountStatisics'
...
const Statistics: React.VFC = () => {
  ...
  const { data } = useSWR(`${process.env.NEXT_PUBLIC_API_URL}/web/stat/statistics`)
