...
const Banner: React.VFC = () => {
  ...
  return (
    <section className="section-1-kv">
			<div className="bg">
				<img src="/images/index-sechtion-1-bg.png"/>
			</div>
			<div className="bg-top-let">
				<img src="/images/index-sechtion-1-item1.png"/>
			</div>
			<div className="bg-top-right">
				<img src="/images/index-sechtion-1-item2.png"/>
			</div>
			...
			<div className="float-ite01">
				<img src="/images/float_ite01.png"/>
			</div>
			<div className="float-ite02">
				<img src="/images/float_ite02.png"/>
			</div>
              ...
              <svg id="Group_6882" data-name="Group 6882" xmlns="http://www.w3.org/2000/svg"
				...
				<div className="right-box">
					<div className="bn-kvbox">
						<div className="base1">
							<img src="/images/bn-img02.png"/>
						</div>
						<div className="base2">
							<img src="/images/bn-img01.png"/>
						</div>
						<div className="base3">
							<img src="/images/bn-img03.png"/>
						</div>
						<div className="animal1">
							<img src="/images/bn-img04.png"/>
						</div>
						<div className="animal2">
							<img src="/images/bn-img05.png"/>
						</div>
					</div>
				</div>
			</div>
